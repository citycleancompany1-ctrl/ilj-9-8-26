          ...
          <div className="p-3.5 bg-blue-50/70 border border-blue-200 rounded-xl space-y-2">
            <div className="flex items-center justify-between text-blue-900">
              ...
              >
                ...
                <span>{copiedDns ? 'Copied' : 'Copy Target'}</span>
              </button>
            </div>
            <div className="grid grid-cols-3 gap-2 text-[11px] font-mono bg-white p-2 rounded-lg border border-blue-100">
              <div>
              ...
              <div>
                <span className="text-gray-400 block text-[9px] uppercase font-sans">Name / Host</span>
                <span className="font-bold text-slate-900">@ or www</span>
              </div>
              <div>
                <span className="text-gray-400 block text-[9px] uppercase font-sans">Points to Target</span>
                <span className="font-bold text-orange-600">indianlalaji.com</span>
              </div>
            </div>
          </div>
